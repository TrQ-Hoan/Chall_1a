        ...
        <div class="btn-toolbar justify-content-between" role="toolbar">
            <form class="d-flex" role="search">
                <div class="input-group">
                    ...
                    <input class="form-control" type="search" name="search" placeholder="Search..." aria-label="Search" <?php
                                                                                                                        if (isset($search)) {
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        if ($_SESSION['user_role'] === 'teacher') {
                            ...
                            echo '<form style="display: inline;" class="me-2" action="/remove.php?type=user&id=' . $row['id'] . '"><button class="btn btn-sm btn-danger" type="submit"><i class="bi bi-trash"></i></button></form>';
                        }
                        echo '<form style="display: inline;" action="/user.php?id=' . $row['id'] . '"><button class="btn btn-sm btn-info" type="submit"><i class="bi bi-info-circle"></i></button></form>';
                        echo '</td>';
                        echo '</tr>';
                    }
                } else {
